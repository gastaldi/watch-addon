== watch-addon
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The watch-addon addon enables blah blah...)
...
----
<dependency>
   <groupId>org.watch.addon</groupId>
   <artifactId>watch-addon</artifactId>
